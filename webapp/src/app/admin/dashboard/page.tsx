...
export default async function AdminDashboard() {
  ...
  const displayStats = await prisma.display.aggregate({
    _count: {
      id: true
    }
  });
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Quick Actions</h2>
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Manage Displays</h3>
                <p className="text-sm text-gray-600">Edit and configure display content</p>
              </div>
            </a>
             ...
             >
               ...
               <div>
                 <h3 className="font-semibold text-gray-900">Scheduled Displays</h3>
                 <p className="text-sm text-gray-600">Automate content updates</p>
               </div>
             </a>
             ...
             >
               ...
               <div>
                 ...
                 <p className="text-sm text-gray-600">Browse and manage all images</p>
               </div>
             </a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">View system overview</p>
              </div>
            </a>
          </div>
        </div>
